...
class CocoDataModule(pl.LightningDataModule):
    ...
    def setup(self, stage: Optional[str] = None):
        ...
        #self.file_list= self.file_list[:2*self.size_val_set*self.batch_size*20]
...
class COCOSegmentation(VisionDataset):
    def __init__(
        ...
        if mask_type == "thing":
            seg_folder = (
                "annotations/semantic_segmentations_{}2017/"
            )
            json_file = "annotations/panoptic_val2017.json"
        elif mask_type == "stuff":
            seg_folder = "annotations/stuff_{}2017_pixelmaps/"
            json_file = "annotations/stuff_val2017.json"
        else:
        ...
        self.masks = [
            os.path.join(seg_dir, x.replace("jpg", "png")) for x in self.file_names
        ]
